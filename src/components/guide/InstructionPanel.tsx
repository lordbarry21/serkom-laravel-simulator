    ...
    <aside className="h-full flex flex-col bg-[#111113] border-r border-zinc-800 text-zinc-200 overflow-hidden">
      ...
      <div className="p-4 border-b border-zinc-800/80 bg-[#161618]">
        <div className="flex items-center gap-2 mb-1.5 flex-wrap">
          <span className="text-[10px] font-mono font-semibold px-2 py-0.5 rounded bg-red-950/40 text-red-300 border border-red-800/60">
            Langkah {currentStep.stepNumber}
          </span>
          {currentStep.targetFilePath && (
            <button
              onClick={() => openFile(currentStep.targetFilePath!)}
              className="inline-flex items-center gap-1 text-[11px] font-mono px-2 py-0.5 rounded bg-zinc-800 text-sky-400 border border-zinc-700 hover:border-sky-500/50 hover:bg-zinc-700 transition"
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4 text-xs leading-relaxed text-zinc-300">
        ...
        {currentStep.theorySummary && (
          <div className="p-3 rounded-xl bg-amber-950/20 border border-amber-500/30 text-amber-200 space-y-1">
            <div className="flex items-center gap-1.5 font-semibold text-amber-300 text-xs">
              ...
              <span>Peta Konsep & Hafalan Asesor</span>
            </div>
        ...
        <div className="bg-[#18181b]/70 border border-zinc-800/80 rounded-xl p-3.5 space-y-2.5 shadow-sm">
          <div className="flex items-center justify-between pb-1 border-b border-zinc-800/80">
            ...
            <span className="text-[10px] font-medium text-zinc-400">IDE Highlighting</span>
          </div>
